...
public class RecipeTest extends TestCase {
    ...
    public void testGetNameGivenAllParameters() {
        ...
        Recipe r = new Recipe("Test recipe", "This is a test", ingredient, instruction, duration);
    ...
    public void testGetCookTimeGivenAllParameters() {
        ...
        assertTrue(r.getCookTime().getSeconds() - duration.getSeconds() == 0); // do I use duration.getSeconds or 3600?
    }
